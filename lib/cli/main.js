...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make litecore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      console.log();
      console.log('    $ litecore-node add wallet-service');
      console.log('    $ litecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ litecore-node remove wallet-service');
      console.log('    $ litecore-node remove insight-api');
      console.log();
    });
